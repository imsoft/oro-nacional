...
export default function BlogCategoriesAdmin() {
  ...
  const [categoryToDelete, setCategoryToDelete] = useState<BlogCategoryListItem | null>(null);
  ...
  const handleDeleteClick = (category: BlogCategoryListItem) => {
    ...
    <div>
      ...
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Button
          ...
          asChild
        >
          <Link href="/admin/blog/categorias/nuevo">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex items-center justify-end gap-2">
                        <Button
                          ...
                          asChild
                        >
                          <Link href={`/admin/blog/categorias/${category.id}/editar`}>
